...
#ifdef OPENCL
// Large vector readbacks: MatVec results in OCL or final solver vectors in OCL_BLAS
TIME_TYPE Timing_GPUReadback;
#endif
...
#ifdef OPENCL
			fprintf(logfile,
				"      vector readback:     "FFORMT"\n",TO_SEC(Timing_GPUReadback));
#endif
#ifdef PARALLEL
			fprintf(logfile,

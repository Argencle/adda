 ...
 */
{
	...
	CL_CH_ERR(clEnqueueNDRangeKernel(command_queue,arith1_kernel,1,NULL,&local_nvoid_Ndip,NULL,0,NULL,
	...
	PROFILE_FIRST_MV_OCL_REGION_END(profile_this_matvec);
	CL_CH_ERR(clEnqueueNDRangeKernel(command_queue,arith5_kernel,1,NULL,&local_nvoid_Ndip,NULL,0,NULL,
